...
model_urls = {
    'drn26': 'http://dl.yf.io/drn/drn26-ddedf421.pth',
    'drn42': 'http://dl.yf.io/drn/drn42-9d336e8c.pth',
    'drn58': 'http://dl.yf.io/drn/drn58-0a53a92c.pth'
}
...
class DRN(nn.Module):
    ...
    def __init__(self, block, layers, num_cls=5,
    ...
    def forward(self, x):
        #print(type(x))
        x = np.concatenate((x.cpu().data.numpy(),x.cpu().data.numpy(),x.cpu().data.numpy()),axis=1)
